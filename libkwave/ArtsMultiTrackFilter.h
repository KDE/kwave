/***************************************************************************
 ArtsMultiTrackFilter.h  -  template for multi-track aRts filters
                             -------------------
...
class ArtsMultiTrackFilter: public ArtsMultiSource, public ArtsMultiSink
{
public:
     ...
     */
    ArtsMultiTrackFilter(unsigned int tracks)
