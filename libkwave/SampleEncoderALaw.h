/*************************************************************************
    SampleEncoderALaw.h  -  encoder for G.711 A-Law compressed samples
                             -------------------
...
#ifndef SAMPLE_ENCODER_ALAW_H
#define SAMPLE_ENCODER_ALAW_H
...
namespace Kwave
{
    class LIBKWAVE_EXPORT SampleEncoderALaw: public Kwave::SampleEncoder
    {
    public:
        ...
        /** Destructor */
        ~SampleEncoderALaw() override = default;
