...
void TestTrack::deleteRange_data()
{
    ...
    QTest::newRow("delete all one stripe")
        << 16384ull <<     0ull << 16384ull;
    QTest::newRow("delete all stripes")
        << 32768ull <<     0ull << 32768ull;
    QTest::newRow("delete first of stripes")
        << 65536ull <<     0ull << 16384ull;
    QTest::newRow("delete interior stripe")
        << 65536ull << 16384ull << 16384ull;
}
