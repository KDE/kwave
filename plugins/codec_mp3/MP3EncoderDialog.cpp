     ...
     m_settings(g_predefined_settings[0])
{
    ...
    // set up all tool tips which contain a % character right here instead
    // of the ui file, as they they would trigger errors during
...
#endif
    QStringList path =
        qEnvironmentVariable("PATH").split(separator, Qt::SkipEmptyParts);
...
#include "moc_MP3EncoderDialog.cpp"
